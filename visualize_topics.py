...
data_folder_security=["0_Credentials.txt"]#["results\Security_data.txt"] #[params.baseline_locations["Nulled_Binary"][1]]
docs, vocab = Utils.load(data_folder_security,clean_string=clean_string,remove_stop_words=remove_stop_words,split_for_cv=True)
